                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Expanded(
                                        child: _buildMetricCard(
                                          ...
                                          value: stats!['numEmployees'].toString(),
                                          icon: Icons.people,
                                          color: Colors.blue,
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        _buildProgressRow(
                                          'Leave Approval Rate',
                                          (stats!['leavesApproved'] / stats!['leavesRequested'] * 100).roundToDouble(),
                                          Icons.approval,
                                        ),
                                        const SizedBox(height: 16),
                                        _buildProgressRow(
                                          'Pending Tasks',
                                          ((stats!['totalTasks'] - stats!['completedTasks']) / stats!['totalTasks'] * 100).roundToDouble(),
                                          Icons.pending,
                                        ),
                                      ],
                                    ),
                                  ...
                                  ...(stats!['departmentStats'] as Map<String, dynamic>).entries.map((entry) {
                                    final deptName = entry.key;
                                    final deptStats = entry.value as Map<String, dynamic>;
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: _getProgressColor(deptStats['completion']).withValues(alpha: 0.1),
                                                  borderRadius: BorderRadius.circular(8),
                                                  border: Border.all(color: _getProgressColor(deptStats['completion']).withValues(alpha: 0.3)),
                                                ),
                                                child: Text(
                                                  ...
                                                  style: GoogleFonts.poppins(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w600,
                                                    color: _getProgressColor(deptStats['completion']),
                                                  ),
                                                ),
                                              ),
                                            ],
                                          ...
                                          LinearProgressIndicator(
                                            value: deptStats['completion'] / 100,
                                            backgroundColor: Colors.grey.shade200,
                                            valueColor: AlwaysStoppedAnimation<Color>(_getProgressColor(deptStats['completion'])),
                                            minHeight: 6,
                                    ...
                                    children: [
                                      Expanded(
                                        child: _buildQuickStatCard(
                                          ...
                                          value: stats!['leavesRequested'].toString(),
                                      ...
                                      Expanded(
                                        child: _buildQuickStatCard(
                                          ...
                                          value: stats!['leavesApproved'].toString(),
