...
class _LeaveApprovalScreenState extends State<LeaveApprovalScreen>
  ...
  Future<void> _fetchLeaveRequests() async {
    if (_managerDepartment == null) {
      setState(() {
        _error = 'Manager department not found';
        _loading = false;
      });
      return;
    }
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          _error =
              'Failed to load leave requests: ${res.statusCode} - ${res.body}';
          _loading = false;
        });
      }
    } catch (e) {
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Failed to update leave status: ${res.statusCode} - ${res.body}',
                    style: GoogleFonts.poppins(fontWeight: FontWeight.w500),
                  ),
                ),
              ],
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Network error while updating status: $e',
                  style: GoogleFonts.poppins(fontWeight: FontWeight.w500),
                ),
              ),
            ],
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'No leave requests found for ${_managerDepartment ?? 'your'} department',
                                        style: GoogleFonts.poppins(
                                          fontSize: 14,
                                          color: Colors.grey.shade600,
                                        ),
