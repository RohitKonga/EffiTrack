...
const { checkIn, checkOut, getHistory, getAttendanceReports, getTeamAttendance, testDeviceTime, checkInDeviceTime } = require('../controllers/attendanceController');
...
router.post('/test-device-time', testDeviceTime);
router.post('/checkin-device-time', auth, checkInDeviceTime);
